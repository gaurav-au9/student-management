...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{asset('admin-theme/bootstrap/css/bootstrap.min.css')}}">
  <!-- Theme style -->
...
<!-- jQuery 3 -->
<script src="{{('admin-theme/plugins/jQuery/jquery-2.2.3.min.js')}}"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{asset('admin-theme/bootstrap/js/bootstrap.min.js')}}"></script>
